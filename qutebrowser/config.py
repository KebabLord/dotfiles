...
c.url.searchengines = { 'DEFAULT':'https://duckduckgo.com/?q={}',
			...
			'proxy':'http://m.trtbanners.com/mobileview/proxy.php/https://www.{}',
			'soundcloud':'https://soundcloud.com/search?q={}',
			'wiki':'https://en.wikipedi0.org/w/index.php?search={}',
			'wikitr':'https://tr.wikipedi0.org/w/index.php?search={}'
		      }

## global css
#c.content.user_stylesheets = ["consolata.css"]
...
#c.content.user_stylesheets = ["/home/admin/Scripts/test.css"]
